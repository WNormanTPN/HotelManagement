...
namespace BUS
{
    public class HoaDonBUS
    {
        ...
        {
            string query = "select maHD, maCTT, tenNV, ngayThanhToan from HoaDon, NhanVien where HOADON.maNV = NHANVIEN.maNV and maHD = '" + maHD + "'";
            return db.getList(query);
        }
